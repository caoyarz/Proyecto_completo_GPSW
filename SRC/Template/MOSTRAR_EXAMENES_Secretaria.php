    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form method="POST" action="MOSTRAR_EXAMENES_Secretaria.php" >
        <?php 
        ...
        <?php }else{ ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="rut_paciente" class="form-control" id="rut_paciente" placeholder="12.345.678-9 (con punto y guión)" required maxlength="12">
                    <br>
